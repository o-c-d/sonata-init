...
namespace Ocd\Sonata\PageBundle\DataFixtures\ORM;
...
CONTENT
    ...
    public function createGlobalPage(SiteInterface $site)
    {
        ...
        // $menu->setSetting('menu_name', "OcdCorporateBundle:Builder:mainMenu");
        ...
        $text->setType('sonata.block.service.text');
        $text->setSetting('content', '<h2>Communication Web</h2><p class="handcraft">HANDCRAFTED IN PARIS<br />WITH MIXED HERITAGE</p><p><a href="http://twitter.com/sonataproject" target="_blank">Follow OcD on Twitter</a></p>');
