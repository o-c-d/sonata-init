...
class Builder extends ContainerAware
{
    ...
    public function mainMenu(FactoryInterface $factory, array $options)
    {
        ...
        $menu->addChild('Stratégie', array('route' => 'page_slug', 'routeParameters' => array('path' => '/strategie')));
        $menu->addChild('Technologie', array('route' => 'page_slug', 'routeParameters' => array('path' => '/technologie')));
        $menu->addChild('Référencement', array('route' => 'page_slug', 'routeParameters' => array('path' => '/referencement')));
    ...
    {
		//$this->mainMenu($factory, array_merge($options, array('is_footer' => true)));
        ...
        $menu->addChild('Accueil', array('route' => 'page_slug', 'routeParameters' => array('path' => '/')));
        $menu->addChild('who-we-are', array('route' => 'page_slug', 'routeParameters' => array('path' => '/who-we-are')));
        $menu->addChild('legal-notes', array('route' => 'page_slug', 'routeParameters' => array('path' => '/legal-notes')));
        $menu->addChild('contact-us', array('route' => 'page_slug', 'routeParameters' => array('path' => '/contact-us')));
        return $menu;
    }
}
